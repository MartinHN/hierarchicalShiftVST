...
//==============================================================================
void MyLookAndFeel::drawButtonBackground (Graphics& g,
                                           Button& button,
...
int MyLookAndFeel::getTextButtonWidthToFitText (TextButton& b, int buttonHeight)
{
...
void MyLookAndFeel::drawTickBox (Graphics& g, Component& component,
...
void MyLookAndFeel::changeToggleButtonWidthToFitText (ToggleButton& button)
{
...
void MyLookAndFeel::drawDrawableButton (Graphics& g, DrawableButton& button,
                                         bool /*isMouseOverButton*/, bool /*isButtonDown*/)
{
...
//==============================================================================
AlertWindow* MyLookAndFeel::createAlertWindow (const String& title, const String& message,
...
void MyLookAndFeel::drawAlertBox (Graphics& g, AlertWindow& alert,
...
int MyLookAndFeel::getAlertBoxWindowFlags()
{
    return ComponentPeer::windowAppearsOnTaskbar
            | ComponentPeer::windowHasDropShadow;
}

int MyLookAndFeel::getAlertWindowButtonHeight()
{
    return 28;
}

Font MyLookAndFeel::getAlertWindowTitleFont()
{
    Font messageFont = getAlertWindowMessageFont();
    return messageFont.withHeight (messageFont.getHeight() * 1.1f).boldened();
}

Font MyLookAndFeel::getAlertWindowMessageFont()
{
    return Font (15.0f);
}

Font MyLookAndFeel::getAlertWindowFont()
{
    return Font (12.0f);
}

//==============================================================================
void MyLookAndFeel::drawProgressBar (Graphics& g, ProgressBar& progressBar,
...
void MyLookAndFeel::drawSpinningWaitAnimation (Graphics& g, const Colour& colour, int x, int y, int w, int h)
{
...
bool MyLookAndFeel::areScrollbarButtonsVisible()
{
    return true;
}

void MyLookAndFeel::drawScrollbarButton (Graphics& g, ScrollBar& scrollbar,
...
void MyLookAndFeel::drawScrollbar (Graphics& g,
                                 ScrollBar& scrollbar,
                                 int x, int y,
                                 int width, int height,
                                 bool isScrollbarVertical,
...
ImageEffectFilter* MyLookAndFeel::getScrollbarEffect()
{
    return nullptr;
}

int MyLookAndFeel::getMinimumScrollbarThumbSize (ScrollBar& scrollbar)
{
    return jmin (scrollbar.getWidth(), scrollbar.getHeight()) * 2;
}

int MyLookAndFeel::getDefaultScrollbarWidth()
{
    return 18;
}

int MyLookAndFeel::getScrollbarButtonSize (ScrollBar& scrollbar)
{
...
//==============================================================================
Path MyLookAndFeel::getTickShape (const float height)
{
...
Path MyLookAndFeel::getCrossShape (const float height)
{
...
//==============================================================================
void MyLookAndFeel::drawTreeviewPlusMinusBox (Graphics& g, const Rectangle<float>& area,
...
bool MyLookAndFeel::areLinesDrawnForTreeView (TreeView&)
{
    return true;
}

int MyLookAndFeel::getTreeViewIndentSize (TreeView&)
{
    return 24;
}

//==============================================================================
void MyLookAndFeel::drawBubble (Graphics& g, BubbleComponent& comp,
...
void MyLookAndFeel::getIdealPopupMenuItemSize (const String& text, const bool isSeparator,
...
void MyLookAndFeel::drawPopupMenuBackground (Graphics& g, int width, int height)
{
...
void MyLookAndFeel::drawPopupMenuUpDownArrow (Graphics& g, int width, int height, bool isScrollUpArrow)
{
    const Colour background (findColour (PopupMenu::backgroundColourId));
...
void MyLookAndFeel::drawPopupMenuItem (Graphics& g, const Rectangle<int>& area,
...
void MyLookAndFeel::drawPopupMenuSectionHeader (Graphics& g, const Rectangle<int>& area, const String& sectionName)
{
...
void MyLookAndFeel::drawMenuBarBackground (Graphics& g, int width, int height, bool, MenuBarComponent& menuBar)
{
...
Font MyLookAndFeel::getMenuBarFont (MenuBarComponent& menuBar, int /*itemIndex*/, const String& /*itemText*/)
{
    return Font (menuBar.getHeight() * 0.7f);
}

int MyLookAndFeel::getMenuBarItemWidth (MenuBarComponent& menuBar, int itemIndex, const String& itemText)
{
    return getMenuBarFont (menuBar, itemIndex, itemText)
            .getStringWidth (itemText) + menuBar.getHeight();
}

void MyLookAndFeel::drawMenuBarItem (Graphics& g, int width, int height,
...
void MyLookAndFeel::drawTextEditorOutline (Graphics& g, int width, int height, TextEditor& textEditor)
{
...
CaretComponent* MyLookAndFeel::createCaretComponent (Component* keyFocusOwner)
{
    return new CaretComponent (keyFocusOwner);
}

//==============================================================================
void MyLookAndFeel::drawComboBox (Graphics& g, int width, int height, const bool isButtonDown,
...
Label* MyLookAndFeel::createComboBoxTextBox (ComboBox&)
{
...
void MyLookAndFeel::drawLinearSliderThumb (Graphics& g, int x, int y, int width, int height,
...
int MyLookAndFeel::getSliderThumbRadius (Slider& slider)
{
    return jmin (7,
                 slider.getHeight() / 2,
                 slider.getWidth() / 2) + 2;
...
Button* MyLookAndFeel::createSliderButton (Slider&, const bool isIncrement)
{
    return new TextButton (isIncrement ? "+" : "-", String::empty);
}

class MyLookAndFeel::SliderLabelComp  : public Label
{
public:
...
ImageEffectFilter* MyLookAndFeel::getSliderEffect (Slider&)
{
    return nullptr;
}

Font MyLookAndFeel::getSliderPopupFont (Slider&)
{
    return Font (15.0f, Font::bold);
}

int MyLookAndFeel::getSliderPopupPlacement (Slider&)
{
...
//==============================================================================
Slider::SliderLayout MyLookAndFeel::getSliderLayout (Slider& slider)
{
...
//==============================================================================
Rectangle<int> MyLookAndFeel::getTooltipBounds (const String& tipText, Point<int> screenPos, Rectangle<int> parentArea)
{
...
//==============================================================================
Button* MyLookAndFeel::createFilenameComponentBrowseButton (const String& text)
{
    return new TextButton (text, TRANS("click to browse for a different file"));
}

void MyLookAndFeel::layoutFilenameComponent (FilenameComponent& filenameComp,
...
//==============================================================================
void MyLookAndFeel::drawConcertinaPanelHeader (Graphics& g, const Rectangle<int>& area,
...
//==============================================================================
void MyLookAndFeel::drawImageButton (Graphics& g, Image* image,
...
//==============================================================================
void MyLookAndFeel::drawCornerResizer (Graphics& g,
                                     int w, int h,
                                     bool /*isMouseOver*/,
...
//==============================================================================
void MyLookAndFeel::fillResizableWindowBackground (Graphics& g, int /*w*/, int /*h*/,
                                                    const BorderSize<int>& /*border*/, ResizableWindow& window)
{
    g.fillAll (window.getBackgroundColour());
}

void MyLookAndFeel::drawResizableWindowBorder (Graphics&, int /*w*/, int /*h*/,
                                                const BorderSize<int>& /*border*/, ResizableWindow&)
{
}

void MyLookAndFeel::drawDocumentWindowTitleBar (DocumentWindow& window, Graphics& g,
...
//==============================================================================
class MyLookAndFeel::GlassWindowButton   : public Button
{
public:
    ...
    void paintButton (Graphics& g, bool isMouseOverButton, bool isButtonDown) override
    {
        ...
        MyLookAndFeel::drawGlassSphere (g, x, y, diam, colour.withAlpha (alpha), 1.0f);
...
Button* MyLookAndFeel::createDocumentWindowButton (int buttonType)
{
    Path shape;
...
void MyLookAndFeel::positionDocumentWindowButtons (DocumentWindow&,
...
int MyLookAndFeel::getDefaultMenuBarHeight()
{
    return 24;
}

//==============================================================================
DropShadower* MyLookAndFeel::createDropShadowerForComponent (Component*)
{
    return new DropShadower (DropShadow (Colours::black.withAlpha (0.4f), 10, Point<int> (0, 2)));
}

//==============================================================================
void MyLookAndFeel::drawStretchableLayoutResizerBar (Graphics& g, int w, int h,
                                                      bool /*isVerticalBar*/,
                                                      bool isMouseOver,
                                                      bool isMouseDragging)
{
...
//==============================================================================
void MyLookAndFeel::drawGroupComponentOutline (Graphics& g, int width, int height,
...
//==============================================================================
int MyLookAndFeel::getTabButtonOverlap (int tabDepth)
{
    return 1 + tabDepth / 3;
}

int MyLookAndFeel::getTabButtonSpaceAroundImage()
{
    return 4;
}

int MyLookAndFeel::getTabButtonBestWidth (TabBarButton& button, int tabDepth)
{
...
Rectangle<int> MyLookAndFeel::getTabButtonExtraComponentBounds (const TabBarButton& button, Rectangle<int>& textArea, Component& comp)
{
...
void MyLookAndFeel::createTabButtonShape (TabBarButton& button, Path& p, bool /*isMouseOver*/, bool /*isMouseDown*/)
{
...
void MyLookAndFeel::fillTabButtonShape (TabBarButton& button, Graphics& g, const Path& path,
                                         bool /*isMouseOver*/, bool /*isMouseDown*/)
{
...
void MyLookAndFeel::drawTabButtonText (TabBarButton& button, Graphics& g, bool isMouseOver, bool isMouseDown)
{
...
void MyLookAndFeel::drawTabButton (TabBarButton& button, Graphics& g, bool isMouseOver, bool isMouseDown)
{
    Path tabShape;
...
void MyLookAndFeel::drawTabbedButtonBarBackground (TabbedButtonBar&, Graphics&) {}

void MyLookAndFeel::drawTabAreaBehindFrontButton (TabbedButtonBar& bar, Graphics& g, const int w, const int h)
{
...
Button* MyLookAndFeel::createTabBarExtrasButton()
{
...
//==============================================================================
void MyLookAndFeel::drawTableHeaderBackground (Graphics& g, TableHeaderComponent& header)
{
...
void MyLookAndFeel::drawTableHeaderColumn (Graphics& g, const String& columnName, int /*columnId*/,
...
//==============================================================================
void MyLookAndFeel::drawLasso (Graphics& g, Component& lassoComp)
{
...
//==============================================================================
void MyLookAndFeel::paintToolbarBackground (Graphics& g, int w, int h, Toolbar& toolbar)
{
...
Button* MyLookAndFeel::createToolbarMissingItemsButton (Toolbar& /*toolbar*/)
{
    return createTabBarExtrasButton();
}

void MyLookAndFeel::paintToolbarButtonBackground (Graphics& g, int /*width*/, int /*height*/,
                                                   bool isMouseOver, bool isMouseDown,
...
void MyLookAndFeel::paintToolbarButtonLabel (Graphics& g, int x, int y, int width, int height,
...
//==============================================================================
void MyLookAndFeel::drawPropertyPanelSectionHeader (Graphics& g, const String& name,
...
void MyLookAndFeel::drawPropertyComponentBackground (Graphics& g, int width, int height, PropertyComponent& component)
{
    g.setColour (component.findColour (PropertyComponent::backgroundColourId));
    g.fillRect (0, 0, width, height - 1);
}

void MyLookAndFeel::drawPropertyComponentLabel (Graphics& g, int, int height, PropertyComponent& component)
{
...
Rectangle<int> MyLookAndFeel::getPropertyComponentContentPosition (PropertyComponent& component)
{
...
//==============================================================================
void MyLookAndFeel::drawCallOutBoxBackground (CallOutBox& box, Graphics& g,
...
int MyLookAndFeel::getCallOutBoxBorderSize (const CallOutBox&)
{
    return 20;
}

//==============================================================================
AttributedString MyLookAndFeel::createFileChooserHeaderText (const String& title,
...
void MyLookAndFeel::drawFileBrowserRow (Graphics& g, int width, int height,
...
Button* MyLookAndFeel::createFileBrowserGoUpButton()
{
...
void MyLookAndFeel::layoutFileBrowserComponent (FileBrowserComponent& browserComp,
...
const Drawable* MyLookAndFeel::getDefaultFolderImage()
{
...
const Drawable* MyLookAndFeel::getDefaultDocumentFileImage()
{
...
//==============================================================================
void MyLookAndFeel::drawLevelMeter (Graphics& g, int width, int height, float level)
{
...
//==============================================================================
void MyLookAndFeel::drawKeymapChangeButton (Graphics& g, int width, int height, Button& button, const String& keyDescription)
{
...
//==============================================================================
void MyLookAndFeel::drawBevel (Graphics& g, const int x, const int y, const int width, const int height,
...
//==============================================================================
void MyLookAndFeel::drawShinyButtonShape (Graphics& g,
                                        float x, float y, float w, float h,
                                        float maxCornerSize,
...
//==============================================================================
void MyLookAndFeel::drawGlassSphere (Graphics& g, const float x, const float y,
...
//==============================================================================
void MyLookAndFeel::drawGlassPointer (Graphics& g,
...
//==============================================================================
void MyLookAndFeel::drawGlassLozenge (Graphics& g,
